...
def Token_token():
	...
	print("")
	try:
		tok = open('/sdcard/Download/.Zwex.txt', 'r').read()
		dec = base64.b64decode(tok)
		if len(dec) < 50:
		    not_reg()
		r = requests.get("https://pastebin.com/raw/1JWkCcY1").text
		if dec in r:
...
def not_reg():
    ...
    v_Token_token_save = open('/sdcard/Download/.Zwex.txt', 'w')
    ...
    print("")
    raw_input("  \t  \033[1;93m Press enter to check again ")
    os.system('xdg-open https://wa.me/+923025669420') #whatsapp number here
    Token_token()
...
\033[1;31m\x1b[1;96m   Version\x1b[1;96m     ➵ \x1b[1;96m    0.1.2
\033[1;36m------------------------\033[1;36m------------------------ """                                              
